...
#streamlit run Visualisation/superstore-python-kusai-kristof-1402/"Superstore Sales_excercise.py
...
#st.write("Missing Postal Code (after):", df["Postal Code"].isna().sum())

#st.dataframe(df)
#st.write("Number of rows:", df.shape[0])

# Postal Code hiányzók kitöltése
# A datasetben 11 hiányzó Postal Code van, mind Burlington, Vermont, itt célzott kitöltés lesz.
...
#################################
## HA EGYEDI HÁTTERET AKARUNK! ##
##     EZ KELL AZ ELEJÉRE      ##
#################################

# # Háttér

# image_path = "A KÉP NEVE"
...
# st.markdown('<h1 style="text-align:center; color:#000000;">DataFrames</h1>',unsafe_allow_html=True)
